...
void GameState::Initialize()
{
	...
	mAnimationBuilder.
		...
		AddRotationKey({ Quaternion::Zero }, 0.0f).
		AddPositionKey({ 50.0f,25.0f,0.0f }, 2.0f).
		AddRotationKey(Quaternion(25.0f, 10.0f, 10.0f, 1.0f), 2.0f).
		AddScale({ 2.0f,1.0f,1.0f }, 2.0f);
}
